...
type config struct {
	BotToken        string
	OwnerID         int64
	AuthorizedUsers map[int64]int
	SudoOwner       map[int64]int
	TmdbAPI         string
...
var Msg help = help{
	...
	// TelegraphFormat:"<strong>%d</strong>\n<blockquote><strong>Name:</strong> <code>%s</code>\n<aside><strong>Size:</strong> <code>%s</code>\n<strong>Type:</strong> <code>%s</code>\n<strong>Location:</strong> <code>%s</code>\n</aside></blockquote>\n<code><a href='%s'>Link</a></code>",
